...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        <li class="active"><a href="/enron/search">Enron</a></li>
        <li class="active"><a href="/enron/network/">Network Analysis</a></li>
        <li class="active"><a href="/enron/topic/">Topic Analysis</a> </li>
    </ul>
  </div><!-- /.navbar-collapse -->
</nav>
    <div class="container">
